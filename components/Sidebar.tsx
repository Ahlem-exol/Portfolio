  ...
  return (
    <>
      ...
      <h3 className="my-4 text-3xl font-medium tracking-wider font-kaushan">
        Hello it&apos;s  <span className="text-pink ">Ahlem</span> CHELLI
      </h3>
      ...
      <div className="flex justify-around w-9/12 mx-auto my-5 text-pink md:w-full ">
        <a  href="https://www.fiverr.com/ahlemexol?up_rollout=true" rel="noreferrer"  target={'_blank'} >
          <SiFiverr className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://www.linkedin.com/in/ahlem-chelli-03660a1a1/" rel="noreferrer" target={'_blank'}  >
          <AiFillLinkedin className="w-8 h-8 cursor-pointer" />
        </a>
        <a href="https://github.com/Ahlem-exol" rel="noreferrer"  target={'_blank'} >
      ...
      >
        <div className="flex items-center justify-center">
          <GoLocation className="mr-2" /> <span>Algiers,Algeria </span>
        </div>
